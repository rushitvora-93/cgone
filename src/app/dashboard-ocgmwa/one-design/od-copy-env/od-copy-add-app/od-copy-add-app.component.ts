...
import { AddConnServerComponent } from '../../od-virtual-env/od-add-app/add-conn-server/add-conn-server.component';

@Component({
  selector: 'app-od-copy-add-app',
  templateUrl: './od-copy-add-app.component.html',
  styleUrls: ['./od-copy-add-app.component.scss']
})
export class OdCopyAddAppComponent implements OnInit {
  ...
  constructor(private automatorApi: AutomatorApiService,
    ...
    public dialogRef: MatDialogRef<OdCopyAddAppComponent>,
  ...
  saveNewApp() {
    ...
    this.automatorApi.addNewCopyHostApp({
